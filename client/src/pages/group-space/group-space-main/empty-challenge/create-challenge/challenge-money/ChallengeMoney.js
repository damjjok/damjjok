    ...
    return (
        <div className="my-5">
            ...
            <FormControl className="flex flex-col my-8 min-w-lg max-w-lg">
                ...
                <FormHelperText>처음 설정할 금액을 정해주세요. 0원도 괜찮아요!</FormHelperText>
                <div className="flex items-end p-4">
                ...
                <FormHelperText>금액 주기를 설정해주세요. 주기마다 적금처럼 포인트가 쌓여요.</FormHelperText>
                <div className="flex items-end p-4">
                ...
                <FormHelperText>선택한 주기마다 넣을 금액을 설정해주세요. 0원도 가능해요!</FormHelperText>
            </FormControl>
        </div>
    );
}
